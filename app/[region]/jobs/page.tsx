...
export default async function RegionalJobsPage({ params }: Props) {
        ...
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <div className="bg-white border-b sticky top-0 z-10">
                <div className="max-w-3xl mx-auto px-4 py-4">
                    <div className="mb-2">
                        <Link href={`/${region}`} className="text-sm text-gray-500 hover:text-gray-900 flex items-center gap-1">
                            <ArrowLeft size={16} />
                            Volver a locales de {regionName}
                        </Link>
                    </div>
                    <h1 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">
                        Empleos en {regionName}
                    </h1>
