...
const jobSchema = z.object({
    ...
    company_logo: z.string().optional().nullable().or(z.literal("")),
    ...
    city: z.string().min(2, "Ciudad requerida").optional().nullable(),
    region_code: z.string().min(2, "Provincia requerida").optional().nullable(),
    venue_id: z.string().optional().nullable(),

    // Advanced fields
    role_description: z.string().optional().nullable().or(z.literal("")),
    responsibilities: z.string().optional().nullable().or(z.literal("")),
    requirements_min: z.string().optional().nullable().or(z.literal("")),
    requirements_opt: z.string().optional().nullable().or(z.literal("")),
    schedule: z.string().optional().nullable().or(z.literal("")),
...
export function JobForm({ initialData, venueId, onSuccess }: JobFormProps) {
    ...
    const form = useForm<z.infer<typeof jobSchema>>({
        ...
        defaultValues: initialData ? {
            ...
            // Advanced defaults (ensure string)
            role_description: initialData?.role_description || "",
            responsibilities: initialData?.responsibilities || "",
            requirements_min: initialData?.requirements_min || "",
            requirements_opt: initialData?.requirements_opt || "",
